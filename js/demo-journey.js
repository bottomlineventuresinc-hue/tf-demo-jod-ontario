/* Template Factory - Jod Dominguez live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-jod-ontario/';
  var LS_CHANGES = 'tf_jod_change_log_v1';
  var LS_PURCHASED = 'tf_jod_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Kitchen remodel, bathroom remodel, room additions, and general building across Ontario and the Inland Empire. You get a fixed itemised quote before we start, Jod as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Jod at Jod Dominguez. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Jod at Jod Dominguez. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Jod Dominguez. Hang tight.',
        delay,
        function () {
